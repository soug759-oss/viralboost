...
const anthropic = new Anthropic({ apiKey: process.env.ANTHROPIC_API_KEY || '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' });
